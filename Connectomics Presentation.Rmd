...
```{r var_heat_png, echo=FALSE, message=FALSE, warning=FALSE, out.width = '49%',out.height='20%',fig.show='hold',fig.align='center'}
...
- Some clusters are related to the high swimming speed:{106,264,144,141...}
